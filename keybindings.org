...
"w" '(nil :wk "Windows")
"ws" '(nil :wk "Split")
"wsb" '(elib-split-window-below :wk "Split Below/Horizontally")
"wsn" '(elib-split-window-below :wk "Split Below/Horizontally")
"wsr" '(elib-split-window-right :wk "Split Right/Vertically")
"wsf" '(elib-split-window-right :wk "Split Right/Vertically")
"wa" '(ace-window :wk "Ace Window")
"ww" '(ace-window :wk "Ace Window")
"wo" '(other-window :wk "Other window")
"wt" '(elib-ace-swap-window :wk "Transpose")
"wd" '(elib-ace-delete-window :wk "Delete")
...
"w SPC" '(elib-windows-transient-hydra/body :wk "Transient"))
#+END_SRC
...
(elib-leader-def
  "p" '(nil :wk "Projects")
  "pb" '(projectile-switch-to-buffer :wk "Switch to ")
...
(general-def
  ...
  :keymaps '(pdf-view-mode-map pdf-annot-list-map)
...
(elib-leader-def 
 "j" '(nil :wk "Jump")
  "jb" '(avy-pop-mark :wk "Back")
  "jj" '(evil-avy-goto-char-timer :wk "Character (motion)")
  "jl" '(evil-avy-goto-line :wk "Line (motion)")
  "ju" '(spacemacs/avy-goto-url :wk "URL")
  "jU" '(spacemacs/avy-open-url :wk "URL (open)")
  "jw" '(evil-avy-goto-word-or-subword-1 :wk "Word (motion)"
         )
  "jn" '(sp-newline :wk "Split newline")
  "js" '(sp-split-sexp :wk "Split sexp")

"jo" '(open-line :wk "Open line")
"jd" '(dired-jump :wk "Jump to directory")
"j(" '(check-parens :wk "Check Parens")
"jf" '(find-function :wk "Lisp Function" )
"jv" '(find-variable :wk "Lisp Variable")
"jc" '(goto-last-change :wk "Last change")
"jq" '(dumb-jump-quick-look :wk "Quick look")
"jD" '(dired-jump-other-window :wk "Jump to directory (Other window)")
"jS" '(spacemacs/split-and-new-line :wk "Split + New line")
"ji" '(spacemacs/helm-jump-in-buffer :wk "Helm in buffer" )
"j+" '(spacemacs/iwb-region-or-buffer :wk "IWB region or buffer")
"j=" '(spacemacs/indent-region-or-buffer :wk "Indent region or buffer" )
"jI" '(helm-imenu-in-all-buffers :wk "Helm Imenu in all buffers")
"j$" '(spacemacs/push-mark-and-goto-end-of-line :wk "End of line")
"jk" '(spacemacs/evil-goto-next-line-and-indent :wk "Next line and indent")
"j0" '(spacemacs/push-mark-and-goto-beginning-of-line :wk "Beginning of line")
)
...
(elib-leader-def 
  "s" '(nil :wk "Special")
   "ss" '(spacemacs/helm-file-smart-do-search :wk "Search in file")

"sf" '(spacemacs/helm-files-smart-do-search :wk "Search in other file(s)")
"sb" '(spacemacs/helm-buffers-smart-do-search :wk "Search in open buffers")
"sj" '(spacemacs/helm-jump-in-buffer :wk "Jump in buffer")
"se" '(evil-iedit-state/iedit-mode :wk "Iedit")
"sm" '(nil :wk "Multiple cursors")
"smm" '(mc/mark-more-like-this-extended :wk "Mark more like this")
    "sma" '(mc/mark-all-dwim :wk "Mark all DWIM")
    "smb" '(mc/mark-all-like-this :wk "Mark all like this")
    "sme" '(nil :wk "Edit")
    "smel" '(mc/edit-lines :wk "Edit lines")
    "smeb" '(mc/edit-beginnings-of-lines :wk "Edit Beginnings")
    "smee" '(mc/edit-ends-of-lines :wk "Edit Ends")
    "smr" '(set-rectangular-region-anchor :wk "Rectangular Region")
  
    "smt" '(mc/mark-sgml-tag-pair :wk "Mark SGML Tag Pair")
    "sms" '(nil :wk "Sort")
    "smsr" '(mc/reverse-regions :wk "Reverse Region")
    "smss" '(mc/sort-regions :wk "Sort regions")
    "smi" '(nil :wk "Insert")
    "smil" '(mc/insert-letters :wk "Letters")
    "smin" '(mc/insert-numbers :wk "Numbers")
)
...
(elib-leader-def
    ...
    "feb" '(elib-open-bib :wk "Bibliography")
