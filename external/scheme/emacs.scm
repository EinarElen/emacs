...
;; Obtain from guix download "https://github.com/emacs-mirror/emacs.git"



(define-public emacs
  (let ((commit "7844846e3fedac8f32f0d81d3c5e906715d39fd2")
        (revision "0")
    ...
    (source (origin
             (method git-fetch)
             (uri (git-reference  (url "https://github.com/emacs-mirror/emacs.git")
                                  (commit commit)))
             (file-name (git-file-name name version))
             ;; (method url-fetch)
             ;; (uri "https://github.com/emacs-mirror/emacs/archive/emacs-26.3.tar.gz")
             (sha256
              (base32
               "13ni68c293al491w695aa1434blrxzi59jyahk761yar1569wgzl"
               ;; "1gdz3xh3w4w3bl21iwl0g5szh7l6yqfdmxbxkhm6m9mw0vv7shxx"
               ))
    ...
    (arguments
     `(#:tests? #f                      ; no check target
       #:configure-flags (list "--with-modules"
                               ...
                               "--with-imagemagick"
                               "--with-dumping=unexec"
                               "CFLAGS=-Ofast -march=native -mtune=native -fno-finite-math-only"
