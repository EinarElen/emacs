...
#+BEGIN_SRC emacs-lisp
  ...
  ;; (declare-function semantic-gcc-get-include-paths)
  ;; (declare-function server-start)
  ;; (declare-function hydra-add-font-lock)
  ;; (declare-function hydra-default-pre)
  ;; (declare-function hydra-keyboard-quit)
  ;; (declare-function hydra--call-interactively-remap-maybe)
  ;; (declare-function hydra-show-hint)
  ;; (declare-function hydra-set-transient-map)
  ;; (declare-function sp-pair)
  ;; (declare-function helm-find-files)
  ;; (declare-function helm-info-emacs)
  ;; (declare-function helm-autoresize-mode)
  ;; (declare-function yas-global-mode)
  ;; (declare-function TeX-revert-document-buffer)
  ;; (declare-function TeX-command)
  ;; (declare-function TeX-master-file)
  ;; (declare-function semantic-gcc-setup)
  ;; (declare-function flycheck-select-checker)
  ;; (declare-function rtags-enable-standard-keybindings)
  ;; (declare-function rtags-diagnostics)
  ;; (declare-function paredit-mode)
  ;; (declare-function org-babel-do-load-languages)
  ;; (declare-function org-gcal-sync)
  ;; (declare-function cfw:open-calendar-buffer)
  ;; (declare-function cfw:org-create-file-source)
  ;; (declare-function mu4e-read-option)
  ;; (declare-function xah-replace-pairs-region)
  ;; (declare-function spaceline-spacemacs-theme)
  ;; (declare-function spaceline-helm-mode)
  ;; (declare-function spaceline-info-mode)
  ;; (declare-function spaceline-all-the-icons-theme)
  ;; (declare-function eshell-send-input)
  ;; (declare-function exwm-systemtray-enable)
  ;; (declare-function server-running-p)
...
weird places on macos systems.  Because why wouldn't they
be.
#+BEGIN_SRC emacs-lisp
