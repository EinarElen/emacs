...
#+BEGIN_SRC emacs-lisp
  (require 'ox-latex)
  (defun toggle-org-latex-export-on-save (&optional arg)
    (interactive)
    (if (and (not arg) (memq 'org-latex-export-to-pdf after-save-hook))
             (progn (while (memq 'org-latex-export-to-pdf after-save-hook)
