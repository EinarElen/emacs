...
(use-package mu4e
  :disabled t
  :ensure nil
  :when (and (equal emacs-major-version 25) (file-exists-p "/usr/local/bin/mu"))
  :load-path "~/.emacs.d/mu4e"
  :config
...
(use-package meson-ide
  :when (file-exists-p (expand-file-name "org-notes-mode/meson-ide"))
  :load-path "~/.emacs.d/org-notes/meson-ide"
  :ensure nil
  :defer 3
  :preface
  :disabled t
