...
*** Basic
 #+BEGIN_SRC emacs-lisp
   (use-package company
     ...
     company-tooltip-idle-delay 0.00001
...
***** C-headers
 #+BEGIN_SRC emacs-lisp
   (use-package company-c-headers
     ...
     (when (string= system-name "virtualbox") (add-to-list 'company-c-headers-path-system "/usr/lib64/gcc/x86_64-pc-linux-gnu/4.9.3/include/"))
     (when (string= system-name "fed-lap") (add-to-list 'company-c-headers-path-system "/usr/include/c++/6.1.2/"))
  ...
  (defun toggle-org-latex-export-on-save()
    ...
    (if (memq 'org-latex-export-to-pdf after-save-hook)
        (progn (remove-hook 'after-save-hook 'org-latex-export-to-pdf t)
               (message
                "Disabled org latex export on save for current buffer..."))
      (progn (add-hook 'after-save-hook 'org-latex-export-to-pdf nil t)
