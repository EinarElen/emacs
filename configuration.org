...
- [[#emacs-setup][Emacs Setup]]
  ...
  - [[#improve-basic-emacs-experience][Improve Basic Emacs Experience]]
  - [[#looksthemes][Looks/Themes]]
  - [[#text-editing][Text Editing]]
  - [[#pdf-handling][PDF-Handling]]
- [[#developmentwriting][Development/Writing]]
...
- [[#org-mode][Org Mode]]
  ...
  - [[#refile][Refile]]
  - [[#calendar][Calendar]]
  - [[#table-of-content-generation][Table of Content Generation]]
...
- The main directory for emacs configuration files in
[[elisp:(find-variable 'user-emacs-config-directory)][`user-emacs-config-directory']]. We do this so we can redefine
[[elisp:(find-variable 'user-emacs-directory)][`user-emacs-directory']] later to store random local files
outside of our configuration directory.
...
(eval-when-compile
  ...
  (defcustom script-file-file-name
    (expand-file-name
     (concat user-emacs-directory "scripts.org"))
